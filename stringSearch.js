...
function getDocsStats(fileContent) {
    ...
    uncommonWords = filterStopWord(wordArray);
...
function filterStopWord(wordArray) {
...
// a list of stop words we don't want to inclue in stats
...
function performMark() {
    ...
    // add the mark the to the book content
